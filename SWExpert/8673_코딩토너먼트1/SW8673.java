	...
	public static void main(String[] args) {
		...
		while (participate >= 1) {
			...
			if (participate > 2) {
				...
				System.out.println("최종 우승 : " + gamer[gamer.length - 1]);
			}

			participate /= 2;
//			if(participate==1) {
//				if(gamer[0]>=gamer[1]) {
//					System.out.print("우승 : " + gamer[0] + " ");
//					gapLevel[currentGapLevel]=gamer[0]-gamer[1];
//					gamer[updateParticipate]=gamer[1];
//				}
//				else {
//					System.out.print("우승 : " + gamer[1] + " ");
//					gapLevel[currentGapLevel]=gamer[1]-gamer[0];
//					gamer[updateParticipate]=gamer[1];
//				}
//			}
		}
